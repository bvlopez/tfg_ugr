...
public class BattleSkillButton : MonoBehaviour, IPointerDownHandler
{
    private Skill skill;
    private GameObject panel;
    private BattleSkillsManager menuSkillsManager;
    ...
    void Start()
    {   
        panel = GameObject.Find("SkillsPanel");
        menuSkillsManager = panel.GetComponent<BattleSkillsManager>();
        selected = false;
        GetComponent<Image>().color = new Color(194, 194, 194, 255);
    }
}
